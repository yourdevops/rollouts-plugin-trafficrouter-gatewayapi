...
// getBackendRefsWithSkipIndexes is like getBackendRefs but skips route rules at the
// given indexes. This is used to exclude managed routes (header routes) from weight updates.
